...
public class TestResultDataBaseHelper extends SQLiteOpenHelper {
    ...
    public TestResultDataBaseHelper(@Nullable Context context) {
    ...
    public boolean addOne(TestResult testResult){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_TEST_NAME, testResult.getTestName());
        cv.put(COLUMN_TEST_SCORE, testResult.getScore());
        cv.put(COLUMN_TEST_TOTAL, testResult.getTotal());
        cv.put(COLUMN_TEST_ANSWERS, testResult.getAnswers().toString());
    ...
    public List<TestResult> getAllTestsResults(){
        List<TestResult> returnList = new ArrayList<>();
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                TestResult resultModel = new TestResult(testId, testName, testScore, testTotal, testAnswers);
