...
public class RoadMarkingRoadSignsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyRoadSignAdapter myRoadSignAdapter = new MyRoadSignAdapter(myRoadSignData, RoadMarkingRoadSignsActivity.this);
